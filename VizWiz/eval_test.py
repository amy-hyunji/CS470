...
def main():
    ...
    test_loader = get_loader(config, split='test')
    
    model = nn.DataParallel(models.Model(config, test_loader.dataset.num_tokens)).cuda()
    ...
    print("<the reults of the test result>:",eval_results)
