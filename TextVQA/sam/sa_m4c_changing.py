...
class SAM4C(nn.Module):
    ...
    def __init__(self, mmt_config, text_bert_config,lr_scale_frcn):
        super().__init__()
        self.mmt_config = mmt_config
        self.text_bert_config = text_bert_config
        self.lr_scale_frcn = lr_scale_frcn 
    ...
    def build(self):
        ...
        self.finetune_modules = [] # list of the data

        # split model building into several components
        self._build_txt_encoding()  # 0
        self._build_obj_encoding()  # 1
        self._build_ocr_encoding()  # 2
        self._build_mmt()
        self._build_output()
        if self.use_aux_heads:
